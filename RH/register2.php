...
if($CheminAct=='/prjet/RH/register2.php'){
...
<body>
    ...
    <div class="container">
        ...
        <h2>Inscription</h2>
            ...
            <div class="form-group">
                <label for="numéro">Numéro du téléphone:</label>
                <input type="number" id="tel" name="telephone" required>
            </div>
            <div class="form-group">
                <label for="poste">Service:</label>
                <input type="text" id="poste" name="service" required>
            </div>
            <div class="form-group">
                <label for="dated">Date début du stage :</label>
                <input type="date" id="dated" name="dated" required>
            </div>
            <div class="form-group">
                <label for="datef">Date fin du stage :</label>
            ...
            <div class="form-group">
                <label>Genre:</label>
                <input type="radio" id="genre_homme" name="genre" value="homme" checked>
