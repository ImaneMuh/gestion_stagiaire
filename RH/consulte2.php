...
<div class="container">
    ...
    <div class="profile">
        ...
        <div class="profile-details">
            <p><strong>Nom :</strong> <?php echo $rows['nom_stag'];?></p>
            <p><strong>Email :</strong> <?php echo $rows['email_stag'];?> </p>
            <p><strong>Service :</strong><?php echo $rows['service_stag'];?></p>
            <p><strong>Catégorie :</strong><?php echo $rows['categorie'];?></p>
            <p><strong>Date début du stage :</strong><?php echo $rows['date_debut'];?></p>
            <p><strong>Date fin du stage :</strong><?php echo $rows['date_fin'];?></p>
            <p><strong>Numéro du téléphone :</strong><?php echo $rows['tel_stag'];?></p>
